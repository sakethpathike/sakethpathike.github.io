...
way ( <a href="https://web.archive.org/web/20140802140223/https://kotlinlang.org/" rel="nofollow">Captured on Aug 02 2014</a> ).`,1),ve=r(`<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <hr/> <!> <!> <p><!></p>`,1);function m(r){var l=ve(),u=n(l);c(u,{children:(t,n)=>{var r=re();a(5),e(t,r)},$$slots:{default:!0}});var d=i(u,2);c(d,{children:(n,r)=>{a(),e(n,t(`While I got to know about Kotlin from Android development, it has grown a lot since then. The first-party
...
Android, but also in the backend.`))},$$slots:{default:!0}});var f=i(d,2);c(f,{children:(n,r)=>{a(),e(n,t(`Now that there is an official language server, I hope it will continue to evolve further. I’m kinda biased towards
Kotlin for a couple of reasons. Irrespective of that, I think Kotlin is great at what it does.`))},$$slots:{default:!0}});var p=i(f,2);s(p,{level:1,children:(n,r)=>{a(),e(n,t(`Multiplatform with Kotlin`))},$$slots:{default:!0}});var m=i(p,2);c(m,{children:(t,n)=>{a();var r=ie();a(4),e(t,r)},$$slots:{default:!0}});var h=i(m,2);c(h,{children:(n,r)=>{a(),e(n,t(`The core and common logic is separated from the respective platform stuff in a typical KMP project, so you end up
writing platform-specific stuff individually while the common code remains the same across the targeted platforms.`))},$$slots:{default:!0}});var g=i(h,2);c(g,{children:(t,n)=>{var r=ae();a(5),e(t,r)},$$slots:{default:!0}});var _=i(g,2);o(_,{text:`expect suspend fun deleteAutoBackups(
    backupLocation: String,
    threshold: Int, onCompletion: (deletionCount: Int) -> Unit
)`});var v=i(_,2);c(v,{children:(t,n)=>{a();var r=oe();a(2),e(t,r)},$$slots:{default:!0}});var y=i(v,2);c(y,{children:(n,r)=>{a(),e(n,t(`Now on Android, the implementation for this may look like:`))},$$slots:{default:!0}});var b=i(y,2);o(b,{text:`actual suspend fun deleteAutoBackups(
...
}`});var ye=i(b,2);c(ye,{children:(n,r)=>{a(),e(n,t(`But the same function’s implementation on a desktop target will look like:`))},$$slots:{default:!0}});var x=i(ye,2);o(x,{text:`actual suspend fun deleteAutoBackups(
    backupLocation: String, threshold: Int, onCompletion: (deletionCount: Int) -> Unit
) {
    try {
        withContext(Dispatchers.IO) {
...
}`});var S=i(x,2);c(S,{children:(n,r)=>{a(),e(n,t(`The platform-specific APIs or implementations get involved with this expect/actual mechanism, which makes things
straightforward and pretty clear.`))},$$slots:{default:!0}});var C=i(S,2);c(C,{children:(t,n)=>{a();var r=se();a(2),e(t,r)},$$slots:{default:!0}});var w=i(C,2);c(w,{children:(n,r)=>{a(),e(n,t(`If you are dealing with composables or classes or an interface implementation on specific platforms or anything that is
platform-specific, this mechanism remains the same.`))},$$slots:{default:!0}});var T=i(w,2);c(T,{children:(n,r)=>{a(),e(n,t(`I never tried other multiplatform frameworks/tools, but I think this is the simplest yet finest way to deal with
...
platform-level APIs, and I think KMP does it most finely.`))},$$slots:{default:!0}});var E=i(T,2);s(E,{level:2,children:(n,r)=>{a(),e(n,t(`The Nitpicks`))},$$slots:{default:!0}});var D=i(E,2);c(D,{children:(n,r)=>{a(),e(n,t(`Now the nitpick I have here has to do more with CMP than KMP: CMP is maintained by JetBrains, which is not on the latest
version regularly with respect to the upstream version, and some components like material expressive aren’t yet possible
to use directly in the common codebase, but again, this is just a nitpick.`))},$$slots:{default:!0}});var O=i(D,2);c(O,{children:(n,r)=>{a(),e(n,t(`This has nothing to do with KMP, but you also need to know that yep, this sort of thing exists where you might end up
not using the library you used to use when on a single targeted codebase, so you end up writing your own thing in the
common codebase or with expect/actual blocks, which is fine, at least for me.`))},$$slots:{default:!0}});var k=i(O,2);c(k,{children:(t,n)=>{a();var r=ce();a(2),e(t,r)},$$slots:{default:!0}});var A=i(k,2);c(A,{children:(t,n)=>{a();var r=le();a(2),e(t,r)},$$slots:{default:!0}});var j=i(A,2);s(j,{level:1,children:(n,r)=>{a(),e(n,t(`Coroutines and Flows in KMP`))},$$slots:{default:!0}});var M=i(j,2);c(M,{children:(t,n)=>{a();var r=ue();a(2),e(t,r)},$$slots:{default:!0}});var N=i(M,2);c(N,{children:(t,n)=>{a();var r=de();a(4),e(t,r)},$$slots:{default:!0}});var P=i(N,2);c(P,{children:(n,r)=>{a(),e(n,t(`We need the “Event-driven” style to complete the operation; this is, of course, your typical asynchronous use case,
which Kotlin coroutines and flows do excellently in my usage.`))},$$slots:{default:!0}});var F=i(P,2);c(F,{children:(n,r)=>{a(),e(n,t(`This function needs to use platform-specific APIs to pick a directory:`))},$$slots:{default:!0}});var I=i(F,2);o(I,{text:`expect suspend fun pickADirectory(): String?`});var L=i(I,2);c(L,{children:(n,r)=>{a(),e(n,t(`Now, you would call this typically from a ViewModel or any other class; when dealing with the desktop target, this is
...
}`});var z=i(R,2);c(z,{children:(n,r)=>{a(),e(n,t(`When targeting Android, the implementation will be based on Android-specific APIs.`))},$$slots:{default:!0}});var B=i(z,2);c(B,{children:(t,n)=>{a();var r=fe();a(6),e(t,r)},$$slots:{default:!0}});var V=i(B,2);c(V,{children:(t,n)=>{var r=pe();a(3),e(t,r)},$$slots:{default:!0}});var H=i(V,2);c(H,{children:(n,r)=>{a(),e(n,t(`The implementation would look like:`))},$$slots:{default:!0}});var U=i(H,2);o(U,{text:`actual suspend fun pickADirectory(): String? {
...
}`});var W=i(U,2);c(W,{children:(t,n)=>{a();var r=me();a(4),e(t,r)},$$slots:{default:!0}});var G=i(W,2);o(G,{text:`val activityResultLauncherForPickingADirectory =
...
}`});var K=i(G,2);c(K,{children:(t,n)=>{var r=he();a(),e(t,r)},$$slots:{default:!0}});var q=i(K,2);o(q,{text:` fun CoroutineScope.pushUIEvent(type: Type) {
    this.launch {
        _androidUIEventChannel.send(type)
    }
}`});var J=i(q,2);c(J,{children:(n,r)=>{a(),e(n,t(`So I think we are clear on the usage of coroutines in KMP. Similarly, I have also used shared flows in some cases, like:`))},$$slots:{default:!0}});var Y=i(J,2);o(Y,{text:`@Composable
...
}`});var X=i(Y,2);c(X,{children:(n,r)=>{a(),e(n,t(`Which is collected from the Android codebase to minimize the app.`))},$$slots:{default:!0}});var Z=i(X,2);c(Z,{children:(n,r)=>{a(),e(n,t(`I’m sure there are other ways to implement all of this, but I did it like this, and all this remains solid handling in
my use cases.`))},$$slots:{default:!0}});var Q=i(Z,4);c(Q,{children:(t,n)=>{a();var r=ge();a(2),e(t,r)},$$slots:{default:!0}});var $=i(Q,2);c($,{children:(t,n)=>{a();var r=_e();a(2),e(t,r)},$$slots:{default:!0}});var be=i($,2);ne(ee(be),{src:`/images/kmp-in-practice/kotlin-site-archive-capture-2014.png`}),te(be),e(r,l)}export{m as default,l as metadata};