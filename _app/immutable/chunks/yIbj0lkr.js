import{B as e,R as ee,S as t,T as n,et as r,tt as te,w as i,z as ne}from"./CXOUEYH_.js";import"./CFKVnMbq.js";import"./DCKuasBZ.js";import{t as a}from"./B2HDiynK.js";import"./N-6q-Igo.js";import{c as o,i as s,s as re}from"./DJSaBRCA.js";var c={title:`Kotlin Multiplatform, in practice`,description:`Multiplatform is fun, at least with Kotlin.`,pubDatetime:`Aug 03, 2025 07:30 PM IST`,staticRes:`kmp-in-practice`},{title:l,description:u,pubDatetime:d,staticRes:f}=c,ie=i(`<a href="https://kotlinlang.org/" rel="nofollow">kotlinlang.org</a> used to say <code>A modern programming language that makes developers happier</code> and
...
way ( <a href="https://web.archive.org/web/20140802140223/https://kotlinlang.org/" rel="nofollow">Captured on Aug 02 2014</a> ).`,1),ye=i(`<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <hr/> <!> <!> <p><!></p>`,1);function p(i){var c=ye(),l=ne(c);s(l,{children:(e,ee)=>{var n=ie();r(5),t(e,n)},$$slots:{default:!0}});var u=e(l,2);s(u,{children:(e,ee)=>{r(),t(e,n(`While I got to know about Kotlin from Android development, it has grown a lot since then. The first-party
...
Android, but also in the backend.`))},$$slots:{default:!0}});var d=e(u,2);s(d,{children:(e,ee)=>{r(),t(e,n(`Now that there is an official language server, I hope it will continue to evolve further. I’m kinda biased towards
Kotlin for a couple of reasons. Irrespective of that, I think Kotlin is great at what it does.`))},$$slots:{default:!0}});var f=e(d,2);o(f,{level:1,children:(e,ee)=>{r(),t(e,n(`Multiplatform with Kotlin`))},$$slots:{default:!0}});var p=e(f,2);s(p,{children:(e,ee)=>{r();var n=ae();r(4),t(e,n)},$$slots:{default:!0}});var m=e(p,2);s(m,{children:(e,ee)=>{r(),t(e,n(`The core and common logic is separated from the respective platform stuff in a typical KMP project, so you end up
writing platform-specific stuff individually while the common code remains the same across the targeted platforms.`))},$$slots:{default:!0}});var h=e(m,2);s(h,{children:(e,ee)=>{var n=oe();r(5),t(e,n)},$$slots:{default:!0}});var g=e(h,2);a(g,{text:`expect suspend fun deleteAutoBackups(
    backupLocation: String,
    threshold: Int, onCompletion: (deletionCount: Int) -> Unit
)`});var _=e(g,2);s(_,{children:(e,ee)=>{r();var n=se();r(2),t(e,n)},$$slots:{default:!0}});var v=e(_,2);s(v,{children:(e,ee)=>{r(),t(e,n(`Now on Android, the implementation for this may look like:`))},$$slots:{default:!0}});var y=e(v,2);a(y,{text:`actual suspend fun deleteAutoBackups(
...
}`});var b=e(y,2);s(b,{children:(e,ee)=>{r(),t(e,n(`But the same function’s implementation on a desktop target will look like:`))},$$slots:{default:!0}});var x=e(b,2);a(x,{text:`actual suspend fun deleteAutoBackups(
    backupLocation: String, threshold: Int, onCompletion: (deletionCount: Int) -> Unit
) {
    try {
        withContext(Dispatchers.IO) {
...
}`});var S=e(x,2);s(S,{children:(e,ee)=>{r(),t(e,n(`The platform-specific APIs or implementations get involved with this expect/actual mechanism, which makes things
straightforward and pretty clear.`))},$$slots:{default:!0}});var C=e(S,2);s(C,{children:(e,ee)=>{r();var n=ce();r(2),t(e,n)},$$slots:{default:!0}});var w=e(C,2);s(w,{children:(e,ee)=>{r(),t(e,n(`If you are dealing with composables or classes or an interface implementation on specific platforms or anything that is
platform-specific, this mechanism remains the same.`))},$$slots:{default:!0}});var T=e(w,2);s(T,{children:(e,ee)=>{r(),t(e,n(`I never tried other multiplatform frameworks/tools, but I think this is the simplest yet finest way to deal with
...
platform-level APIs, and I think KMP does it most finely.`))},$$slots:{default:!0}});var E=e(T,2);o(E,{level:2,children:(e,ee)=>{r(),t(e,n(`The Nitpicks`))},$$slots:{default:!0}});var be=e(E,2);s(be,{children:(e,ee)=>{r(),t(e,n(`Now the nitpick I have here has to do more with CMP than KMP: CMP is maintained by JetBrains, which is not on the latest
version regularly with respect to the upstream version, and some components like material expressive aren’t yet possible
to use directly in the common codebase, but again, this is just a nitpick.`))},$$slots:{default:!0}});var D=e(be,2);s(D,{children:(e,ee)=>{r(),t(e,n(`This has nothing to do with KMP, but you also need to know that yep, this sort of thing exists where you might end up
not using the library you used to use when on a single targeted codebase, so you end up writing your own thing in the
common codebase or with expect/actual blocks, which is fine, at least for me.`))},$$slots:{default:!0}});var O=e(D,2);s(O,{children:(e,ee)=>{r();var n=le();r(2),t(e,n)},$$slots:{default:!0}});var k=e(O,2);s(k,{children:(e,ee)=>{r();var n=ue();r(2),t(e,n)},$$slots:{default:!0}});var A=e(k,2);o(A,{level:1,children:(e,ee)=>{r(),t(e,n(`Coroutines and Flows in KMP`))},$$slots:{default:!0}});var j=e(A,2);s(j,{children:(e,ee)=>{r();var n=de();r(2),t(e,n)},$$slots:{default:!0}});var M=e(j,2);s(M,{children:(e,ee)=>{r();var n=fe();r(4),t(e,n)},$$slots:{default:!0}});var N=e(M,2);s(N,{children:(e,ee)=>{r(),t(e,n(`We need the “Event-driven” style to complete the operation; this is, of course, your typical asynchronous use case,
which Kotlin coroutines and flows do excellently in my usage.`))},$$slots:{default:!0}});var P=e(N,2);s(P,{children:(e,ee)=>{r(),t(e,n(`This function needs to use platform-specific APIs to pick a directory:`))},$$slots:{default:!0}});var F=e(P,2);a(F,{text:`expect suspend fun pickADirectory(): String?`});var I=e(F,2);s(I,{children:(e,ee)=>{r(),t(e,n(`Now, you would call this typically from a ViewModel or any other class; when dealing with the desktop target, this is
...
}`});var R=e(L,2);s(R,{children:(e,ee)=>{r(),t(e,n(`When targeting Android, the implementation will be based on Android-specific APIs.`))},$$slots:{default:!0}});var z=e(R,2);s(z,{children:(e,ee)=>{r();var n=pe();r(6),t(e,n)},$$slots:{default:!0}});var B=e(z,2);s(B,{children:(e,ee)=>{var n=me();r(3),t(e,n)},$$slots:{default:!0}});var V=e(B,2);s(V,{children:(e,ee)=>{r(),t(e,n(`The implementation would look like:`))},$$slots:{default:!0}});var H=e(V,2);a(H,{text:`actual suspend fun pickADirectory(): String? {
...
}`});var U=e(H,2);s(U,{children:(e,ee)=>{r();var n=he();r(4),t(e,n)},$$slots:{default:!0}});var W=e(U,2);a(W,{text:`val activityResultLauncherForPickingADirectory =
...
}`});var G=e(W,2);s(G,{children:(e,ee)=>{var n=ge();r(),t(e,n)},$$slots:{default:!0}});var K=e(G,2);a(K,{text:` fun CoroutineScope.pushUIEvent(type: Type) {
    this.launch {
        _androidUIEventChannel.send(type)
    }
}`});var q=e(K,2);s(q,{children:(e,ee)=>{r(),t(e,n(`So I think we are clear on the usage of coroutines in KMP. Similarly, I have also used shared flows in some cases, like:`))},$$slots:{default:!0}});var J=e(q,2);a(J,{text:`@Composable
...
}`});var Y=e(J,2);s(Y,{children:(e,ee)=>{r(),t(e,n(`Which is collected from the Android codebase to minimize the app.`))},$$slots:{default:!0}});var X=e(Y,2);s(X,{children:(e,ee)=>{r(),t(e,n(`I’m sure there are other ways to implement all of this, but I did it like this, and all this remains solid handling in
my use cases.`))},$$slots:{default:!0}});var Z=e(X,4);s(Z,{children:(e,ee)=>{r();var n=_e();r(2),t(e,n)},$$slots:{default:!0}});var Q=e(Z,2);s(Q,{children:(e,ee)=>{r();var n=ve();r(2),t(e,n)},$$slots:{default:!0}});var $=e(Q,2);re(ee($),{src:`/images/kmp-in-practice/kotlin-site-archive-capture-2014.png`}),te($),t(i,c)}export{p as default,c as metadata};